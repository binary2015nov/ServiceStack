    ...
    public class RequestInfoHandler : HttpAsyncTaskHandler
    {
        ...
        {          
            ...
            var response = new RequestInfoResponse
            {
                ...
                Host = HostContext.AppHost.GetType().Name + "_" + HostContext.AppHost.Config.DebugHttpListenerHostEnvironment + "_" + Env.ServerUserAgent,
                ...
                RootDirectoryPath = HostContext.AppHost.VirtualFileSources.RootDirectory.RealPath,
                StripApplicationVirtualPath = HostContext.AppHost.Config.StripApplicationVirtualPath,
                ...
                Stats = new Dictionary<string, string> {
                    ...
                    {"EnableFeatures", HostContext.AppHost.Config.EnableFeatures.ToString() },
