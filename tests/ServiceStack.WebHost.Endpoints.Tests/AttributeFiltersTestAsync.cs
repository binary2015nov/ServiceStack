...
namespace ServiceStack.WebHost.Endpoints.Tests
{
	...
	{
		public ContextualResponseFilterTestAsyncAttribute(ApplyTo applyTo) : base(applyTo) { }
	...
	{		
		...
		static IServiceClient[] ServiceClients =
		{
			...
			//new Soap11ServiceClient(Config.ListeningOn),
			//new Soap12ServiceClient(Config.ListeningOn)
		};
		...
		{
			var client = new HtmlServiceClient(Config.ListeningOn);
			client.SetBaseUri(Config.ListeningOn);
