...
namespace ServiceStack.WebHost.Endpoints.Tests
{
    ...
    {
        public class CorsFeatureAppHostHttpListener : AppHostHttpListenerBase
        {
            public CorsFeatureAppHostHttpListener() : base("Cors Feature Tests", typeof(CorsFeatureService).Assembly) { }
        ...
        public void CorsMethodHasAccessControlHeaders(IRestClient client)
        {
            ...
            var response = RequestContextTests.GetResponseHeaders(Config.AbsoluteBaseUri + "/corsmethod");
        ...
        public void GlobalCorsHasAccessControlHeaders()
        {
            ...
            var response = RequestContextTests.GetResponseHeaders(Config.AbsoluteBaseUri + "/globalcorsfeature");
