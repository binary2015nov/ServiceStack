...
namespace ServiceStack.WebHost.Endpoints.Tests
{
    ...
    public class RuntimeAttributeTests
    {
        ...
        {
            public RuntimeAttributeAppHost() : base(typeof(RuntimeAttributeTests).Name, typeof (RuntimeAttributeAppHost).Assembly)
            {
        ...
        {
            var restPath = HostContext.ServiceController.GetRestPathForRequest("GET", "/custom-register", null);
