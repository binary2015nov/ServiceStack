...
namespace ServiceStack.WebHost.IntegrationTests.Tests
{
        ...
        : RestsTestBase
    {
        ...
        {
            IServiceClient client = new JsonServiceClient(Constants.ServiceStackBaseHost);
            ...
            var response = client.PostFileWithRequest<FileUploadResponse>(Constants.ServiceStackBaseHost + "/fileuploads", uploadFile, request);
        ...
        public void Can_POST_upload_file_using_ServiceClient_with_request_and_QueryString()
        {
            ...
            var response = client.PostFileWithRequest<FileUploadResponse>(
                Constants.ServiceStackBaseHost + "/fileuploads?CustomerId=123&CustomerName=Foo,Bar",
                uploadFile, request);
