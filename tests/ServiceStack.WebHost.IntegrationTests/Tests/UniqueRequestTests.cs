...
namespace ServiceStack.WebHost.IntegrationTests.Tests
{
    ...
    public class UniqueRequestTests
    {
        ...
        public void Can_handle_encoded_chars()
        {
            ...
            response = Constants.ServiceStackBaseHost.AppendPath("request/123%7C456").GetStringFromUrl();
            Assert.That(response, Is.EqualTo("123|456"));
        }
        ...
        {
            var url = Constants.ServiceStackBaseHost.AppendPath("collections")
            ...
            url = Constants.ServiceStackBaseHost.AppendPath("collections")
                .AddQueryParam("Ids", "1")
                .AddQueryParam("Ids", "2")
                .AddQueryParam("Ids", "3")
        ...
        {
            var url = Constants.ServiceStackBaseHost.AppendPath("json/reply/Collections")
                .AddQueryParam("Ids", "1,2,3")
                .AddQueryParam("Names", "A,B,C");
            ...
            url = Constants.ServiceStackBaseHost.AppendPath("json/reply/Collections")
                .AddQueryParam("Ids", "1")
                .AddQueryParam("Ids", "2")
                .AddQueryParam("Ids", "3")
                .AddQueryParam("Names", "A")
