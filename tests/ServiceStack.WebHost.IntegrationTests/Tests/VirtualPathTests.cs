...
namespace ServiceStack.WebHost.IntegrationTests.Tests
{
    ...
    public class VirtualPathTests
    {
        ...
        {
            var contents = "{0}/Sub/static-sub-embedded.txt".Fmt(ServiceStackBaseUri).GetStringFromUrl();
            Assert.That(contents, Is.EqualTo("static"));
        }
        ...
        public void Can_download_default_static_file_at_sub_directory()
        {
            ...
            Assert.That(contents, Does.Contain("static"));
        }
        ...
        public void Can_download_EmbeddedResource_Template_HtmlFormat()
        {
            ...
            Assert.That(contents, Does.Contain("Snapshot of <i>Hello</i> generated by <a href=\"https://servicestack.net\">ServiceStack</a>"));
        }
